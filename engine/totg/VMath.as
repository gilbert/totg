// Taken from http://flashgamedojo.com/wiki/index.php?title=VMath
package engine.totg {
	/**
	...
	public class VMath {
		 ...
		 */
		static public function add(v1:Object, v2:Object):void {
			v1.x += v2.x;
			v1.y += v2.y;
		}
		/**
		 * Calculates the distance squared from first vector to second vector.
		 */
		static public function subtract(v1:Object, v2:Object):void {
			v1.x -= v2.x;
			v1.y -= v2.y;
		}
		/**
		 ...
		 */
		static public function multiply(v1:Object, value:Number):void {
			v1.x * value;
			v1.y * value;
		}
		 ...
		 * @param value 	The value to multiply the vector instance by.
		 */
		static public function divide(v1:Object, value:Number):void {
			v1.x / value;
			v1.y / value;
		}
		/**
		 ...
		 */
		static public function normalize(v:Object):void {
			var vx:Number = v.x;
			var vy:Number = v.y;
		 ...
		 */
		static public function truncate(v:Object, max:Number):void {
			var vx:Number = v.x;
			var vy:Number = v.y;
		...
		static public function reverse(v:Object):void {
			v.x = -v.x;
			v.y = -v.y;
		}
